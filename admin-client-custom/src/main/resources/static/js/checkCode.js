function check() {
	...
	var xmlHttp;
	if (window.XMLHttpRequest) { // 如果是ie7以上浏览器，使用new new
		// XMLHttpRequest()创建对象
	...
	// var v =document.getElementById("vcode").value;
	// xmlHttp.open("GET", "CheckCode?vcode=" + v + "&random=" + Math.random,
	// true);
	// xmlHttp.send();
}
function delData() {
...
// 刷新验证码
function reloadcode() {
	document.getElementById("codeImg").src = "../CodeServlet?" + new Date();
}
